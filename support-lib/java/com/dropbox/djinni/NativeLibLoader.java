 ...
 * and records. To loadMore libraries in your application at startup,
 * simply place them:
 ...
 * </code>
 * to loadMore the libraries (e.g. in your main() or a class static initializer).
 */
public class NativeLibLoader {
    ...
    public static void loadLibs() throws URISyntaxException, IOException {
        // Try to loadMore from Jar
        loadLibsFromJarPath(djinniNativeLibsJarPath);

        // Try to loadMore from system
    ...
    public static void loadLibsFromJarPath(String jarPath)
        ...
        // Walk the directory and loadMore libs
        FileSystem fs =
